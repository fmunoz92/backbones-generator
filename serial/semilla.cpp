...
{
    /* Los valores semilla */
    arbol_data->atm[0].x = 0.000;
    arbol_data->atm[0].y = 0.000;
    arbol_data->atm[0].z = 0.000;
    arbol_data->atm[1].x = 1.460;
    arbol_data->atm[1].y = 0.000;
    arbol_data->atm[1].z = 0.000;
    arbol_data->atm[2].x = 2.011;
    arbol_data->atm[2].y = 1.422;
    arbol_data->atm[2].z = 0.000;
    arbol_data->atm[0].vdw = N  ;
    arbol_data->atm[1].vdw = CA  ;
    arbol_data->atm[2].vdw = C;
